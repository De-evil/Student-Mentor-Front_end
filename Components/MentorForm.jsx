...
function MentorForm() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const posted_mentor = await axios.post(`https://student-mentor-back-end-2.onrender.com/Mentors/`,{name,email,course});
        setMentors([...mentors,posted_mentor.data])
        setname('');setemail('');setcourse('');
    }
    return (
        <form onSubmit = {handleSubmit}>
            <h4 className="text-info" style={{color: "red"}} >Mentor Form</h4>
            <div className="mb-3">
